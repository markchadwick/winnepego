...
class TestParser extends TestCase {
  ...
  function testShortLiteralOverrun() {
    ...
    switch(result) {
      case Pass(_, _, res): fail("unexpected res: "+ res);
      case Fail(_, pos, msg):
        assertEquals(0, pos);
  ...
  function testParse666() {
    ...
    switch(result) {
      case Pass(_, _, res): assertEquals(666, res);
      case _: fail("unexpected failure");
    }
  }
  ...
  function testConsumeOtherParser() {
    ...
    switch(result) {
      case Pass(_, _, res): assertEquals('hello', res);
      case Fail(_, _, msg): fail("unexpected failure: "+ msg);
    }
  }
  ...
  function testConsumeField() {
    ...
    switch(result) {
      case Pass(_, _, res): assertEquals(321, res);
      case Fail(_, _, msg): fail("unexpected failure: "+ msg);
    }
  }
  ...
  function testThenPass() {
    ...
    switch(result) {
      case Pass(_, _, res): assertEquals('a:a, b:b', res);
      case Fail(_, _, msg): fail("unexpected failure: "+ msg);
    }
  }
  ...
  function testThenFailFirst() {
    ...
    switch(result) {
      case Pass(_, _, res): fail("should not have passed, got: "+ res);
      case Fail(_, _, msg): assertEquals("Expected 'a' got 'b'", msg);
    }
  }
  ...
  function testThenFailSecond() {
    ...
    switch(result) {
      case Pass(_, _, res): fail("should not have passed, got: "+ res);
      case Fail(_, _, msg): assertEquals("Expected 'b' got 'a'", msg);
    }
  }
  ...
  function testAny() {
    ...
    switch(result) {
      case Pass(_, _, res): assertEquals('6,6,6', res);
      case Fail(_, _, msg): fail("unexpected failure: "+ msg);
    }
  }
  ...
  function testAtLeastOneFails() {
    ...
    switch(result) {
      case Pass(_, _, res): throw "should not have passed";
      case Fail(_, _, msg):
  ...
  function testRangePass() {
    ...
    switch(result) {
      case Pass(_, _, res): assertEquals(5, res);
      case Fail(_, _, msg): fail("unexpected failure: "+ msg);
    }
  }
  ...
  function testRangeFail() {
    ...
    switch(result) {
      case Pass(_, _, res): fail("Expected failure, got " + res);
      case Fail(_, _, msg): assertEquals("Expected 0-9 got 'k'", msg);
    }
  }
  ...
  function testRepeatedRange() {
    ...
    switch(result) {
      case Pass(_, _, res): assertEquals(123, res);
      case Fail(_, _, msg): fail("unexpected failure: "+ msg);
    }
  }
  ...
  function testCombinedParsers() {
    ...
    switch(p(Bytes.ofString('more than 12'), 0)) {
      case Pass(_, _, res): assertEquals(13, res);
  ...
  function testOr() {
    ...
    switch(p(Bytes.ofString('a'), 0)) {
      case Pass(_, _, res): assertEquals('a', res);
      case Fail(_, _, msg): fail("unexpected failure: "+ msg);
    }

    switch(p(Bytes.ofString('b'), 0)) {
      case Pass(_, _, res): assertEquals('b', res);
      case Fail(_, _, msg): fail("unexpected failure: "+ msg);
    }
  }
  ...
  function testOrFail() {
    ...
    switch(p(Bytes.ofString('c'), 0)) {
      case Pass(_, _, res): throw "passed with "+ res;
      case Fail(_, _, msg):
